                                ...
                                <form class="form" action="<%=url%>" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control"
                                                          ...
                                                          spellcheck="false" data-value="<%=products.getDescription()%>"></textarea>
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="form-group">
                                                <select name="categoryId" class="choices form-select" data-value="<%=products.getCategoryId()%>">
                                                    <%for (int i = 0; i < categories.size(); i++) {%>
                                                    <option value="<%=categories.get(i).getId() == products.getCategoryId()%>"><%=categories.get(i).getName()%>
                                                    </option>
                                                    <%}%>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <label>Status</label>
                                            <div class="form-group">
                                                <select name="status" class="choices form-select" data-value="<%=products.getStatus()%>">
